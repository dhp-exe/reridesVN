...
- Calculates distances and routes via OpenRouteService.
...
- OpenRouteService API Key: Get a free key from openrouteservice.org.

**Backend Setup:**

The backend handles routing calculations and price estimations.
